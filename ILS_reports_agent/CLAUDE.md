...
pip install -r ILS_reports_agent/requirements.txt
...
При добавлении или изменении функций, работающих с PSS REST API (api/pss_*_api.py, ILS_reports_agent/pss/api_client.py):
